...
public class AjJbDO implements java.io.Serializable {
	...
	public AjJbDO(Integer ajxh, String ah, String ajmc, String ajxz,
			...
			Integer gdxlh, Date cbrbprq, String jar, Date spzsqrq,
			...
			String psycy, String msajtjs, String msajtjsss, String shwdfxpg,
			String sfsqsfqr, String sfjgyla, String sfyyffa, String yffa,
			String sfhj, String fxhjcs, String ysfysffczs, String sfktsl,
			String pjsffdjfnr, String sftz, String sfdtpj, String zytj,
			String sfxess, Integer ajdjcs) {
		this.ajxh = ajxh;
		this.ah = ah;
		this.ajmc = ajmc;
		this.ajxz = ajxz;
	...
	@Column(name = "SFSQSFQR", length = 1)
	public String getSfsqsfqr() {
		return this.sfsqsfqr;
	}
	...
	@Column(name = "YSFYSFFCZS", length = 10)
	public String getYsfysffczs() {
		return this.ysfysffczs;
	}
	...
	@Column(name = "AJDJCS")
	public Integer getAjdjcs() {
		return this.ajdjcs;
	}

	public void setAjdjcs(Integer ajdjcs) {
		this.ajdjcs = ajdjcs;
	}
