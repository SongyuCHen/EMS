			...
			<div id="right">
				...
				<div id="content">
					<div id="tjdykdd">
						...
						<form action="bckdd.do" method="POST" class="table-wrapper scroll-table">
						<c:forEach items="${kdtdxxs }" var="kdtdxx">
							<table class="T-table">
								<tbody>
									<tr>
										<th><span class="needed">*</span>案号：</th><td><input name="ah" type="text" value="${kdtdxx.ah }"></td>
										<th>收件人姓名：</th><td><input name="sjrxm" type="text" value="${kdtdxx.sjrxm }"></td>
										<th>移动电话：</th><td><input name="yddh" type="text" value="${kdtdxx.yddh }"></td>
									</tr>
									<tr>
										<th>单位名称：</th><td><input name="dwmc" type="text" value="${kdtdxx.dwmc }"></td>
										<th>住宅电话：</th><td><input name="zzdh" type="text" value="${kdtdxx.zzdh }"></td>
										<th>办公电话：</th><td><input name="bgdh" type="text" value="${kdtdxx.bgdh }"></td>
									</tr>
									<tr>
										<th><span class="needed">*</span>收件人地址：</th><td colspan="3"><input name="sjrdz" type="text" style="width: 400px;" value="${kdtdxx.sjrdz }"></td>
										<th>邮政编码：</th><td><input name="yzbm" type="text" value="${kdtdxx.yzbm }"></td>
									</tr>
									<tr>
										<th>寄件内容：</th>
										<td colspan="5">
									...
									<tr>
										<th>寄件人电话：</th><td><input name="jjrdh" type="text" value="${kdtdxx.jjrdh }"></td>
										<th>寄件人姓名：</th><td><input name="jjrxm" type="text" value="${kdtdxx.jjrxm }"></td>
